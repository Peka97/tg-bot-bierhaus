...
def get_shops_keyboard(time):
    ...
    for shop_id, shop_addresses in data['shop_addresses'][time].items():
        shops_keyboard.add((InlineKeyboardButton(
            shop_id[5:], callback_data=shop_id)))
...
def get_work_start_keyboard():
    yes_btn = InlineKeyboardButton(
        'Систему 1С открыла', callback_data='work_start')
    keyboard = InlineKeyboardMarkup()
...
def get_layout_keyboard():
    yes_btn = InlineKeyboardButton(
        'Товар разложен', callback_data='layout_yes')
    keyboard = InlineKeyboardMarkup()
    keyboard.add(yes_btn)
    return keyboard
...
def get_send_cash_keyboard():
    btn = InlineKeyboardButton(
        'Средства получены', callback_data='send_cash_yes')
    keyboard = InlineKeyboardMarkup()
    keyboard.add(btn)
    return keyboard
...
def get_revision_keyboard():
    yes_btn = InlineKeyboardButton(
        'Ревизия проведена', callback_data='revision_yes')
    keyboard = InlineKeyboardMarkup()
    keyboard.add(yes_btn)
    return keyboard
...
def get_expiration_date_keyboard():
    yes_btn = InlineKeyboardButton(
        'Срок годности проверен', callback_data='expiration_date_yes')
    keyboard = InlineKeyboardMarkup()
    keyboard.add(yes_btn)
    return keyboard
...
def get_work_done_keyboard():
    no_btn = InlineKeyboardButton(
        'Закрыла смену в 1С', callback_data='is_work_no')
    keyboard = InlineKeyboardMarkup()
    keyboard.add(no_btn)
    return keyboard
